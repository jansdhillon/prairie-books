...
export const NewsletterTemplate: React.FC<Readonly<NewsletterTemplateProps>> = ({
  ...
  <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333' }}>
    <h1 style={{ color: '#4a5568', borderBottom: '1px solid #e2e8f0', paddingBottom: '10px' }}>Latest News from Kathrin's Books</h1>
    <p>Hello {name},</p>
    <p>We're excited to share the latest news and updates from Kathrin's Books with you:</p>
    ...
    <div style={{ marginTop: '30px', borderTop: '1px solid #e2e8f0', paddingTop: '10px', fontSize: '0.9em', color: '#718096' }}>
      <p>This email was sent to {email} because you're subscribed to our newsletter.</p>
    </div>
  </div>
);
